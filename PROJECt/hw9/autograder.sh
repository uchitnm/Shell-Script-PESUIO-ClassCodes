...
for i in ${dir_cont}; do
    ...
    if [ ! ${stud_file} == "" ]; then
        ...
        python3 mail.py ${i} ${stud_mark} ${final_no} hangman.python3@gmail.com # send the mail to the student using python3
        echo ""
        echo "----------------------------------------------------"
        ...
        python3 mail.py ${i} '' '' hangman.python3@gmail.com # send the mail to the student using python3
        echo ""
        echo "----------------------------------------------------"
    fi
